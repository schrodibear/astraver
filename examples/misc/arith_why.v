            ...
            let (a0, b0, p0, result2, Post10) =
              let (a0, b0, p0, result2, Inv) =
                (((((((((((well_founded_induction Z) (Zwf ZERO))
                          (mult_po_1 x y Pre5 result Post1 result0 Post2
                          result1 Post3))
                         [Variant1: Z](a0: Z)(b0: Z)(p0: Z)(_: Variant1 = a0)(Inv: `
                         a0 >= 0` /\ `p0 + a0 * b0` = `x * y`)(sig_4 Z Z Z
                         unit [a1:Z][b1:Z][p1:Z][result:unit](`a1 >= 0` /\
                         `p1 + a1 * b1` = `x * y` /\ a1 = `0`)))
                        [Variant1: Z]
                          [wf1: (Variant2: Z)(Pre1: (Zwf `0` Variant2 Variant1))(a0: Z)(b0: Z)(p0: Z)(_: 
                            Variant2 = a0)(Inv: `a0 >= 0` /\
                            `p0 + a0 * b0` = `x * y`)(sig_4 Z Z Z
                            unit [a1:Z][b1:Z][p1:Z][result:unit](`a1 >= 0` /\
                            `p1 + a1 * b1` = `x * y` /\ a1 = `0`))]
                            [a0: Z]
                              [b0: Z]
                                      ...
                                      | (left Test4) =>
                                          let (a1, b1, p1, result3, Inv) =
                                            let (a1, b1, p1, result3, Inv) =
                                              ...
                                              let Pre3 =
                                                (mult_po_5 x y Pre5 result
                                                Post1 result0 Post2 result1
                                                Post3 Variant1 a0 b0 p0 Pre4
                                                Inv Test4 p1 Post12) in
                                              ...
                                              a2 >= 0` /\
                                              `p2 + a2 * b2` = `x * y` /\
                                              (Zwf `0` a2 a0) a1 b1 p1
                                              result5
                                              (mult_po_6 x y Pre5 result
                                              Post1 result0 Post2 result1
                                              Post3 Variant1 a0 b0 p0 Pre4
                                              Inv Test4 p1 Post12 Pre3 a1
                                              Post5 b1 Post6)) in
                                            (((((((wf1 a1)
                                                   (mult_po_7 x y Pre5 result
                                                   Post1 result0 Post2
                                                   result1 Post3 Variant1 a0
                                                   b0 p0 Pre4 Inv Test4 a1 b1
                                                   p1 Inv)) a1) b1) p1)
                                               (refl_equal ? a1))
                                              (mult_po_8 x y Pre5 result
                                              Post1 result0 Post2 result1
                                              Post3 Variant1 a0 b0 p0 Pre4
                                              Inv Test4 a1 b1 p1 Inv)) in
                                          (exist_4 [a2: Z][b2: Z][p2: Z][result4: unit]`
                                          a2 >= 0` /\
                                          `p2 + a2 * b2` = `x * y` /\
                                          a2 = `0` a1 b1 p1 result3 Inv)
                                      | (right Test1) =>
                                          let (a1, b1, p1, result3, Inv) =
                                            (exist_4 [a1: Z][b1: Z][p1: Z][result3: unit]`
                                            a1 >= 0` /\
                                            `p1 + a1 * b1` = `x * y` /\
                                            a1 = `0` a0 b0 p0 tt
                                            (mult_po_9 x y Pre5 result Post1
                                            result0 Post2 result1 Post3
                                            Variant1 a0 b0 p0 Pre4 Inv Test1)) in
                                          (exist_4 [a2: Z][b2: Z][p2: Z][result4: unit]`
                                          a2 >= 0` /\
                                          `p2 + a2 * b2` = `x * y` /\
                                          a2 = `0` a1 b1 p1 result3 Inv) end))
                       result) result) result0) result1)
                   (refl_equal ? result))
                  (mult_po_10 x y Pre5 result Post1 result0 Post2 result1
                  Post3)) in
              let (result3, Post15) =
                (exist_1 [result3: Z]result3 = `x * y` p0
                (mult_po_11 x y Pre5 result Post1 result0 Post2 result1 Post3
                a0 b0 p0 Inv)) in
              (exist_4 [a1: Z][b1: Z][p1: Z][result4: Z]result4 = `x * y` 
              a0 b0 p0 result3 Post15) in
            (exist_3 [a1: Z][b1: Z][result3: Z]result3 = `x * y` a0 b0
            result2 Post10) in
