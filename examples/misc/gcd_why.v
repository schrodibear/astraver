...
Lemma gcd1_po_6 : 
  ...
  (Pre2: `0 < x0` /\ `0 < y0` /\ `(gcd x0 y0) = (gcd a b)`)
  (Test1: `x0 = y0`)
  `0 < x0` /\ `0 < y0` /\ `(gcd x0 y0) = (gcd a b)` /\ `x0 = y0`.
Proof.
Intuition.
Save.
             ...
             `0 < y0` /\ `(gcd x0 y0) = (gcd a b)`]
              ...
              | (left Test4) =>
                  let (x1, y1, result2, Post5) =
                    let (x1, y1, result2, Post6) =
                      let (x1, y1, result2, Post6) =
                        ...
                        | (left Test3) =>
                            ...
                            (exist_3 [x2: Z][y1: Z][result4: unit]`0 < x2` /\
                            `0 < y1` /\ `(gcd x2 y1) = (gcd a b)` /\
                        ...
                        | (right Test2) =>
                            ...
                            (exist_3 [x1: Z][y2: Z][result4: unit]`0 < x1` /\
                            `0 < y2` /\ `(gcd x1 y2) = (gcd a b)` /\
                    ...
                    ((wf1 (max x1 y1))
                      ...
                      (refl_equal ? (max x1 y1))
                      (gcd1_po_5 a b Pre4 result Post1 result0 Post2 Variant1
                      x0 y0 Pre3 Pre2 Test4 x1 y1 Post6)) in
                  (exist_3 [x2: Z][y2: Z][result3: unit]`0 < x2` /\
              ...
              | (right Test1) =>
                  let (x1, y1, result2, Post5) = (exist_3 [x1: Z][y1: Z]
                    ...
                    (gcd1_po_6 a b Pre4 result Post1 result0 Post2 Variant1
                    x0 y0 Pre3 Pre2 Test1)) in
                  (exist_3 [x2: Z][y2: Z][result3: unit]`0 < x2` /\
                  `0 < y2` /\ `(gcd x2 y2) = (gcd a b)` /\ `x2 = y2` 
                  x1 y1 result2 Post5) end) (max result result0) result
            result0 (refl_equal ? (max result result0))
            (gcd1_po_7 a b Pre4 result Post1 result0 Post2)) in
        let (result2, Post12) = (exist_1 [result2: Z]`result2 = (gcd a b)` 
          x0 (gcd1_po_8 a b Pre4 result Post1 result0 Post2 x0 y0 Post5)) in
...
Lemma gcd2_po_6 : 
  ...
  (Pre3: `0 <= x0` /\ `0 <= y0` /\ `(gcd x0 y0) = (gcd a b)`)
  (Test1: `y0 = 0`)
  `0 <= x0` /\ `0 <= y0` /\ `(gcd x0 y0) = (gcd a b)` /\ `y0 = 0`.
Proof.
Intuition.
Save.
             ...
             `0 <= y0` /\ `(gcd x0 y0) = (gcd a b)`]
              ...
              | (left Test2) =>
                  let (x1, y1, result2, Post6) =
                    ...
                    ((wf1 y1)
                      ...
                      (refl_equal ? y1)
                      (gcd2_po_5 a b Pre5 result Post1 result0 Post2 Variant1
                      x0 y0 Pre4 Pre3 Test2 x1 y1 Post7)) in
                  (exist_3 [x2: Z][y2: Z][result3: unit]`0 <= x2` /\
              ...
              | (right Test1) =>
                  let (x1, y1, result2, Post6) = (exist_3 [x1: Z][y1: Z]
                    ...
                    (gcd2_po_6 a b Pre5 result Post1 result0 Post2 Variant1
                    x0 y0 Pre4 Pre3 Test1)) in
                  (exist_3 [x2: Z][y2: Z][result3: unit]`0 <= x2` /\
                  `0 <= y2` /\ `(gcd x2 y2) = (gcd a b)` /\ `y2 = 0` 
                  x1 y1 result2 Post6) end) result0 result result0
            (refl_equal ? result0)
            (gcd2_po_7 a b Pre5 result Post1 result0 Post2)) in
        let (result2, Post11) = (exist_1 [result2: Z]`result2 = (gcd a b)` 
          x0 (gcd2_po_8 a b Pre5 result Post1 result0 Post2 x0 y0 Post6)) in
        (exist_3 [x1: Z][y1: Z][result3: Z]`result3 = (gcd a b)` x0 y0
        result2 Post11) in
      (exist_2 [x1: Z][result2: Z]`result2 = (gcd a b)` x0 result1 Post9) in
    (exist_1 [result1: Z]`result1 = (gcd a b)` result0 Post8).
