...
(* Why obligation from file "max.mlw", characters 565-578 *)
Lemma pgm_max_end_po_1 : 
  forall (a: (array Z)),
  forall (Pre9: (array_length a) = l),
  forall (x0: Z),
  forall (Post1: x0 = 0),
  forall (y0: Z),
  forall (Post2: y0 = 1),
  ...
  forall (x1: Z),
  forall (y1: Z),
  forall (Pre5: Variant1 = (l - y1)),
  forall (Pre4: (0 <= y1 /\ y1 <= l) /\ (0 <= x1 /\ x1 < l) /\
                (forall (k:Z),
...
Lemma pgm_max_end_po_2 : 
  ...
  forall (Pre4: (0 <= y1 /\ y1 <= l) /\ (0 <= x1 /\ x1 < l) /\
                (forall (k:Z),
                 (0 <= k /\ k < y1 -> (access a k) <= (access a x1)))),
  forall (Test4: y1 < l),
  forall (Pre2: 0 <= y1 /\ y1 < (array_length a)),
...
Lemma pgm_max_end_po_3 : 
  ...
  forall (Test4: y1 < l),
  forall (Pre2: 0 <= y1 /\ y1 < (array_length a)),
  forall (Pre3: 0 <= x1 /\ x1 < (array_length a)),
