...
Definition f91 := (* validation *)
  [n: Z]
    (well_founded_induction Z (Zwf ZERO) f91_po_1 [Variant1: Z](n0: Z)
      (_: Variant1 = (max `0` `101 - n0`))
        ...
        | (left Test2) =>
            let (result0, Post4) =
              let (aux_2, Post5) =
                let (result2, Post6) =
                  ((wf1 (max `0` `101 - (n0 + 11)`))
                    (f91_po_2 Variant1 n0 Pre2 Test2) `n0 + 11`
              ...
              let (result0, Post7) =
                let (result2, Post8) =
                  ((wf1 (max `0` `101 - aux_2`))
                    (f91_po_3 Variant1 n0 Pre2 Test2 aux_2 Post5) aux_2
