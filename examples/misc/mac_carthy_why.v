...
Definition f91 (* validation *)
  ...
  := [n: Z]
       (well_founded_induction Z (Zwf ZERO) (Zwf_well_founded `0`)
         [Variant1: Z](n0: Z)(_: Variant1 = (max `0` `101 - n0`))
           ...
           | (left Test2) =>
               let (result0, Post4) =
                 let (aux_3, Post5) =
                   ...
                   `n0 + 11 >= 101` /\ `result3 = n0 + 11 - 10` result2
                   Post6) in
                 let (result0, Post7) =
                   let (result2, Post8) =
                     ((wf1 (max `0` `101 - aux_3`))
                       (f91_po_2 Variant1 n0 Pre2 Test2 aux_3 Post5) 
                       aux_3 (refl_equal ? (max `0` `101 - aux_3`))) in
