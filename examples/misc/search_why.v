         ...
         let (i0, result0, Post7) =
           let (i0, result0, Post8) =
             (well_founded_induction Z (Zwf ZERO) (Zwf_well_founded `
               0`) [Variant1: Z](i0: Z)
               (_: Variant1 = `(array_length t) - i0`)(_0: `0 <= i0` /\
               ((k:Z) (`0 <= k` /\ `k < i0` -> `(access t k) <> 0`)))
               ...
               [Variant1: Z; wf1: (Variant2: Z)
                ...
                ((k:Z) (`0 <= k` /\ `k < i0` -> `(access t k) <> 0`))]
                 let (result0, Bool2) =
                   let (result2, Post9) =
                     (Z_lt_ge_bool i0 (array_length t)) in
                       ...
                       let (i1, result1, Post13) =
                         let (result1, Post14) =
                           let (result1, Bool1) =
                             let result2 =
                               let Pre2 =
                                 (search1_po_1 t result Post3 Variant1 i0
                                 Pre4 Pre3 Test4) in
                                 ...
                                 ((i:Z)
                                  (i = `i0 + 1` -> (`0 <= i` /\
                                   ...
                                   (Zwf `0` `(array_length t) - i` `(
                                                                    ...
                                                                    i0`))) 
                                 tt
                                 (search1_po_2 t result Post3 Variant1 i0
                                 Pre4 Pre3 Test4 Test2)) in
                               (exist_1 (qcomb [result3: Z]
                                         `(access t result3) = 0`
                                         [result3: unit]
                                         ((i:Z)
       ...
       let (i0, result0, Post6) =
                 ...
                 | (left Test4) =>
                       ...
                       let (i1, result1, Post13) =
                         let (result1, Post14) =
                           let (result1, Bool1) =
                             let result2 =
                               let Pre2 =
                                 (search2_po_1 t result Post3 Variant1 i0
                                 Pre4 Pre3 Test4) in
                               (Z_eq_bool (access t i0)) in
                             let (result3, Post15) = (result2 `0`) in
                             (exist_1 [result4: bool]
                                 ...
                                 ((i:Z)
                                  (i = `i0 + 1` -> (`0 <= i` /\
                                   ...
                                   (Zwf `0` `(array_length t) - i` `(
                                                                    ...
                                                                    i0`))) 
                                 tt
                                 (search2_po_2 t result Post3 Variant1 i0
                                 Pre4 Pre3 Test4 Test2)) in
                               (exist_1 (qcomb [result3: unit]
                     ...
                     | (Qval (exist result2 Post2)) => (exist_2 [i2: Z]
                       (qcomb [result3: unit]`(access t i2) = 0`
                        [result3: unit](`0 <= i2` /\
                        ((k:Z) (`0 <= k` /\ `k < i2` -> `(access t k) <> 0`))) /\
                        `i2 >= (array_length t)`) i1 (Val unit result2)
                       Post2)
             ...
             | (Qexn _ Post27) => (exist_2 [i1: Z]
               (qcomb [result3: unit]`(access t i1) = 0`
                (qcomb [result3: unit]
                 ((k:Z)
                  (`0 <= k` /\ `k < (array_length t)` -> `(access t k) <> 0`))
                 [result3: Z]`(access t result3) = 0`)) i0
               (Val unit (Exn Z tt)) Post27)
             end
         ...
         | (Qval (Qval (exist result1 Post28))) => (exist_2 [i1: Z]
           (qcomb [result2: unit]
            ((k:Z)
             (`0 <= k` /\ `k < (array_length t)` -> `(access t k) <> 0`))
            [result2: Z]`(access t result2) = 0`) i0 (Val unit result1)
           Post28)
         | (Qexn _ Post29) =>
               ...
               | (right Test3) =>
                   let (result0, Post4) =
                     let (result0, Bool5) =
                       let result1 =
                         let Pre2 =
                           (search3_po_3 t Pre13 Pre12 Pre10 Pre11 Variant1
                           i0 Pre8 Pre7 Test3) in
                         (Z_eq_bool (access t i0)) in
                     ...
                     | (right Test1) =>
                         let Pre6 =
                           (search3_po_4 t Pre13 Pre12 Pre10 Pre11 Variant1
                           i0 Pre8 Pre7 Test3 Test1) in
                         let (result1, Post6) =
                           let Pre4 = Pre6 in
                           let Pre5 = Pre4 in
                           let (result3, Post7) =
                             ((wf1 `(array_length t) - (i0 + 1)`)
                               (search3_po_5 t Pre13 Pre12 Pre10 Pre11
                               Variant1 i0 Pre8 Pre7 Test3 Test1 Pre6 Pre4
                               Pre5) `i0 + 1`
                         ...
                         | (Qexn _ Post11) =>
                           (exist_1 (qcomb [result2: unit]
                                     ...
                                     [result2: Z]`(access t result2) = 0`) 
                           (Exn Z tt)
                           (search3_po_6 t Pre13 Pre12 Pre10 Pre11 Variant1
                           i0 Pre8 Pre7 Test3 Test1 Pre6 Post11))
                         end end) in
