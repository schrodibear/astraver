    ...
    let (t0, result, Post15) =
      ...
      let (i0, t0, result0, Post10) =
        (well_founded_induction Z (Zwf ZERO) (Zwf_well_founded `0`)
          ...
          `i0 <= (array_length t0) - 1`) /\ (sorted_array t0 `0` `i0 - 1`) /\
          (permut t0 t) /\
          ((k:Z)
           (`0 <= k` /\ `k < i0` ->
            ((l:Z)
          ...
          [Variant1: Z; wf1: (Variant2: Z)(Pre1: (Zwf `0` Variant2 Variant1))
           (i0: Z)(t0: (array Z))(_: Variant2 = `(array_length t0) - i0`)
           (_0: (`0 <= i0` /\ `i0 <= (array_length t0) - 1`) /\
           (sorted_array t0 `0` `i0 - 1`) /\ (permut t0 t) /\
           ((k:Z)
            (`0 <= k` /\ `k < i0` ->
             ((l:Z)
             ...
             (`0 <= k` /\ `k < i1` ->
              ((l:Z)
               (`i1 <= l` /\ `l < (array_length t1)` ->
                `(access t1 k) <= (access t1 l)`))))) /\
            `i1 >= (array_length t1) - 1`));
           i0: Z; t0: (array Z); Pre12: Variant1 = `(array_length t0) - i0`;
           Pre11: (`0 <= i0` /\ `i0 <= (array_length t0) - 1`) /\
           (sorted_array t0 `0` `i0 - 1`) /\ (permut t0 t) /\
           ((k:Z)
            (`0 <= k` /\ `k < i0` ->
            ...
            (Cases (btest
                    [result0:bool](if result0
                                   then `i0 < (array_length t0) - 1`
                                   else `i0 >= (array_length t0) - 1`)
                    result0 Bool3) of
            | (left Test6) =>
                let (i1, t1, result1, Post10) =
                              ...
                              [Variant3: Z; wf2: (Variant4: Z)
                               ...
                               ((k:Z)
                                ...
                                let (result3, Bool2) =
                                  ...
                                  (if result6 then `j0 < (array_length t0)`
                                   else `j0 >= (array_length t0)`) result5
                                  Post20) in
                                (Cases (btest
                                ...
                                | (right Test2) =>
                                    let (j1, min1, result4, Post3) =
                                      ...
                                      ((k:Z)
                                       (`i0 <= k` /\ `k < j1` ->
                                        `(access t0 min1) <= (access t0 k)`))) /\
                                      `j1 >= (array_length t0)` j0 min0 
                                      tt (conj ? ? Pre5 Test2)) in
                                    (exist_3 [j2: Z][min2: Z][result5: unit]
                                    ((`i0 + 1 <= j2` /\
                                    `j2 <= (array_length t0)`) /\
                                    (`i0 <= min2` /\
                                    ...
                                    `j2 >= (array_length t0)` j1 min1 
                                    result4 Post3) end)
                              `(array_length t0) - result2` result2 result1
                  ...
                  ((wf1 `(array_length t1) - i1`)
                    ...
                    (proj1 ? ? Post12)) in
                (exist_3 [i2: Z][t2: (array Z)][result2: unit]((`0 <= i2` /\
                `i2 <= (array_length t2) - 1`) /\
                (sorted_array t2 `0` `i2 - 1`) /\ (permut t2 t) /\
                ((k:Z)
                 (`0 <= k` /\ `k < i2` ->
                  ((l:Z)
