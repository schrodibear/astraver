...
Rewrite Post4; Omega.
Apply H8; Omega.
Rewrite Post4; Rewrite H10; Omega.
Unfold Zwf; Omega.
Save.
...
Lemma selection_po_12 : 
  ...
  (Pre8: `0 <= i0` /\ `i0 < n`)
  (t1: (array n Z))
  (Post8: t1 = (store t0 min0 (access t0 i0)))
  (t2: (array n Z))
                ...
                let (i1, t1, result1, Post11) =
                  let (i1, t1, result1, Post12) =
                                ...
                                | (left Test5) =>
                                    let (j1, min1, result4, Post6) =
                                      let (j1, min1, result4, Post13) =
                                        let (min1, result4, Post21) =
                                          let (result4, Bool3) =
                                            let Pre3 =
                                              ...
                                              Post1 Variant1 i0 t0 Pre12
                                              Pre11 Test6 result1 Post2
                                              result2 Post3 Variant3 j0 min0
                                              Pre6 Pre5 Test5) in
                                            let result5 =
                                              let Pre4 =
                                                (selection_po_4 t Pre13
                                                result Post1 Variant1 i0 t0
                                                Pre12 Pre11 Test6 result1
                                                Post2 result2 Post3 Variant3
                                        ...
                                        j1 Post5)) in
                                      ((wf2 `n - j1`)
                                        (selection_po_8 t Pre13 result Post1
                                        Variant1 i0 t0 Pre12 Pre11 Test6
                                        result1 Post2 result2 Post3 Variant3
                          ...
                          let (t1, result4, Post24) =
                            ...
                            let (t1, result4, Post25) =
                              let Pre8 =
                                ...
                                Post7) in
                              let (t1, result4, Post8) =
                                let (result4, Post8) = (exist_1 [result4: Z]
                                ...
                                t2 = (store t0 min0 (access t0 i0)) (
                                                                    ...
                                                                    result4)
                                tt Post8) in
                              let (t2, result5, Post9) =
                                let (result5, Post9) = (exist_1 [result5: Z]
                    ...
                    let (i1, result2, Post10) =
                      let (result2, Post10) = (exist_1 [result2: Z]
                        result2 = `i0 + 1` `i0 + 1`
                        (refl_equal ? `i0 + 1`)) in
