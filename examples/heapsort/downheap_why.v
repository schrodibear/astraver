...
Rewrite (H16 i);
[ Decompose [exchange] Post23; Apply H26 | Idtac ];
...
Split; Assumption.
Rewrite (H16 k0). 
Decompose [exchange] Post23. Rewrite H23. 
Elim Post12; Intros.
  (* j' = 2k+1 *)
  Rewrite H26. Generalize Test8; Rewrite Post3. Case H18; Intros.
...
Elim Post12; Intros; Omega'.
  ...
  Intro. Elim Post12; Intros.
    ...
    Rewrite (H16 `2*k0+1`).
    Decompose [exchange] Post23. Rewrite (H29 `2*k0+1`).
  ...
  Intro. Elim Post12; Intros.
    ...
    Rewrite (H16 `2*k0+2`).
    Decompose [exchange] Post23. Rewrite (H28 `2*k0+2`).
    Generalize H20. Case H18; Intros.
    Apply inftree_1 with n:=n0. Auto.
    Omega'. Omega'. Omega'. Omega'.
    Apply inftree_3.
    ...
    (well_founded_induction Z (Zwf ZERO) (Zwf_well_founded `0`) [Variant1: Z]
      ...
      [Variant1: Z; wf1: (Variant2: Z)(Pre1: (Zwf `0` Variant2 Variant1))
       ...
       ((i:Z) (`k0 + 1 <= i` /\ `i <= n0` -> (heap t0 n0 i)))]
                ...
                let (t1, result0, Post19) =
                  ...
                  | (left Test7) =>
                      let (t1, result1, Post22) =
                        ...
                        let (t2, result2, Post25) =
                          ...
                          let (t2, result4, Post26) =
                            ((wf1 `n0 - j'`)
                              ...
                              t1 Post23 Pre11 Pre9 Pre10) j' n0 t1
                              (refl_equal ? `n0 - j'`)
                              (downheap_po_11 k n t Pre15 Variant1 k0 n0 t0
                              Pre14 Pre13 j Post3 Test8 j' Post12 Test7 Pre12
                              t1 Post23 Pre11 Pre9 Pre10)) in
                        ...
                        Pre13 j Post3 Test8 j' Post12 Test7 Pre12 t1 Post23
                        Pre11 t2 Post25)) in
                  ...
                  | (right Test6) =>
                      let (result1, Post21) = (exist_1 [result1: unit]
                        ...
                        Pre13 j Post3 Test8 j' Post12 Test6)) in
        ...
        Post8) `n - k` k n t (refl_equal ? `n - k`) Pre15).
