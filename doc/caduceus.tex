...
tactics. However, this does not work immediately, because indeed we do
...
more complicated, it is nevertheless solves by Simplify automatically.
With Coq, the proof must be completed also follows
\begin{verbatim}
TODO
\end{verbatim}
