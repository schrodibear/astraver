...
have been run: Ergo, Simplify and Z3. Their answers are exactly the
...
\index{termination}
\index{decreases clause@\texttt{decreases} clause}
...
External theorem provers must be installed. Ergo is available from
\url{http://ergo.lri.fr}, simplify is available from \url{} (see why
