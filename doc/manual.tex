...
\item
  ...
  nothing more than a common first-order logic ``format'' for these
  provers. 
...
We first introduce the logic in Section~\ref{logic} and then program
verification in Section~\ref{programs}.

\section{First-order logic}\label{logic}

\why\ implements a polymorphic first-order logic. The typing rules and
semantics of this logic are given in Section~\ref{semantics:logic}.

TODO

\section{Verifying programs}\label{programs}
