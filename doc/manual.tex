...
%%% coverpage
\whytitlepage{The WHY verification tool}{Tutorial and Reference Manual}{\whyversion}{Jean-Christophe Filli\^atre}
...
\begin{figure}
  \centering
  TODO % \includegraphics[width=0.8\textwidth]{WhyWeb.eps}
...
division operator $/$ only applies on reals, not on integer. Divisions
and modulo operations on integers come in library
\texttt{divisions.why} in two flavors: mathematical division division
