  ...
  \begin{displaymath}
    \begin{array}{rrl}
      ...
      e & ~::=~ & t \\
        ...
        &  |~ & \popost{e}{q} \\
        &  |~ & \pfun{x}{\tau}{p}{e} \\
        &  |~ & \precfun{x~(x:\tau)\dots(x:\tau)}{\tau}{t}{p}{e} \\
        &  |~ & \papp{e}{e}
    \end{array}
  \end{displaymath}
...
\begin{displaymath}
  \begin{array}{rl}
    \wprx{\pfun{x}{\tau}{p}{e}}{q}{r} 
    & = q ~\land~ \forall x.\forall\rho. p \Rightarrow\wpre{e}{\textsf{True}}
  \end{array}
\end{displaymath}
\begin{displaymath}
  \begin{array}{l}
    \wprx{\precfun{f~(x_1:\tau_1)\dots(x_n:\tau_n)}{\tau}{t}{p}{e}}{q}{r}
...
$(x_1:\tau_1)\rightarrow\cdots\rightarrow(x_n:\tau_n)\rightarrow\prepost{p\land
  t<\at{t}{L}}{\tau~\epsilon}{q}$
...
$(x:\tau)\rightarrow\prepost{p'}{\tau'~\epsilon}{q'}$, we define
\begin{displaymath}
