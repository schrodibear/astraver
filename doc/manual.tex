...
\newcommand{\indexnt}[1]{\index{#1@\textsl{#1} (non terminal)}}
...
\label{syntax:ml}\index{ML programs!syntax}

\subsection{ML types}
\label{syntax:mltypes}\index{ML types!syntax}
...
\label{syntax:mlexpr}\index{ML expressions!syntax}
...
\subsection{ML files}
\label{syntax:mlfiles}\index{ML files!syntax}
