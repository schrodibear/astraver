...
#define OCT_USE_TAG 1
#define OCT_ENABLE_ASSERT 1
...
#ifdef OCT_USE_TAG
#define oct_nbtags               OCT_PROTO(nbtags)
#define oct_hastags              OCT_PROTO(hastags)
...
#ifdef OCT_USE_TAG
#define oct_fourier_motzkin      OCT_PROTO(fourier_motzkin)
#endif
...
#define zero_n(p,t,n)  ((void) memset ((p),0,sizeof(t)*(n)))
...
#ifdef OCT_USE_TAG
size_t OCT_PROTO(nbtags) (oct_t* m);         /* number of tags */
...
num_t* OCT_PROTO(get_untagged_vars) (oct_t* m);/* untagged variables */
#endif
...
#ifdef OCT_USE_TAG
bool  OCT_PROTO(is_included_in)       (oct_t* ma, oct_t* mb, bool only_context);
#else
...
#ifdef OCT_USE_TAG
oct_t* OCT_PROTO(fourier_motzkin)     (oct_t*       m,
			               var_t        x,
			               bool         destructive);
#endif
