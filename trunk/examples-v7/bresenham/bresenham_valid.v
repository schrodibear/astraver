         ...
         (well_founded_induction Z (Zwf ZERO) (Zwf_well_founded `0`)
           ...
           [Variant1: Z; wf1: (Variant2: Z)
            ...
            Pre3: (`0 <= x1` /\ `x1 <= x2 + 1`) /\ (invariant x1 y1 e1)]
             ...
             Cases
               (btest
                [result2:bool](if result2 then `x1 <= x2` else `x1 > x2`) result2
                Bool2) of
             | (left Test4) =>
                 let (e2, x3, y3, result3, Post8) =
                   let (e2, x3, y3, result3, Post9) =
                     ...
                     let (e2, y3, result3, WP2) =
                       let (result3, Bool1) =
                         let (result5, Post12) = (Z_lt_ge_bool e1 `0`) in
                       ...
                       Cases
                         (btest
                          [result3:bool]
                          (if result3 then `e1 < 0` else `e1 >= 0`) result3
                          Bool1) of
                       | (left Test3) =>
