...
\put(-80,180){\rnode{null}{\makebox(0,0)[l]{\NULL}}}
\put(-80,160){\unode{n0}}
\put(-70,140){\unode{n1}}
\put(-90,140){\unode{n2}}
\put(-100,180){\rnode{p}{\makebox(0,0)[r]{$p$}}}
\put(-100,160){\rnode{t}{\makebox(0,0)[r]{$t$}}}
\put(-100,120){\rnode{null2}{\makebox(0,0)[c]{\NULL}}}
...
\ncline[nodesep=1mm,linewidth=1]{p}{null}
\ncline[nodesepA=1mm,linewidth=1]{t}{n0}
\put(-30,160){\rnode{fig2}}
\put(0,180){\rnode{null}{\makebox(0,0)[b]{\NULL}}}
\put(0,160){\mnode{n0}}
\put(10,140){\unode{n1}}
\put(-10,140){\unode{n2}}
...
\ncline[nodesepB=1mm]{n2}{null2}
\ncline[nodesepB=1mm]{n2}{null3}
\ncarc[nodesepA=1mm,arcangleA=-10,arcangleB=-50,linewidth=1]{p}{n0}
\ncline[nodesepA=1mm,linewidth=1]{t}{n2}
\ncline[linewidth=2mm,linecolor=gray]{fig1}{fig2}\Aput{push}
\put(20,160){\rnode{fig2}}
\put(50,160){\rnode{fig3}}
\put(80,180){\rnode{null}{\makebox(0,0)[b]{\NULL}}}
\put(80,160){\mnode{n0}}
\put(90,140){\unode{n1}}
\put(70,140){\mnode{n2}}
\put(50,135){\rnode{p}{\makebox(0,0)[r]{$p$}}}
\put(40,120){\rnode{t}{\makebox(0,0)[r]{$t$}}}
\put(60,120){\rnode{null2}{\makebox(0,0)[c]{\NULL}}}
\put(80,120){\rnode{null3}{\makebox(0,0)[c]{\NULL}}}
...
\ncline{n0}{n1}
\ncline[nodesepB=1mm]{n2}{null3}
\ncarc[nodesepA=1mm,arcangleA=-10,arcangleB=-40,linewidth=1]{p}{n2}
\ncline[nodesepA=1mm,nodesepB=3mm,linewidth=1]{t}{null2}
...
\put(-80,80){\rnode{null}{\makebox(0,0)[b]{\NULL}}}
\put(-80,60){\mnode{n0}}
\put(-70,40){\unode{n1}}
\put(-90,40){\mnode{n2}}
\put(-110,50){\rnode{p}{\makebox(0,0)[r]{$p$}}}
\put(-60,20){\rnode{t}{\makebox(0,0)[l]{$t$}}}
\put(-100,20){\rnode{null2}{\makebox(0,0)[c]{\NULL}}}
...
\ncline{n0}{n1}
\ncline[nodesepA=1mm,linewidth=1]{p}{n2}
\ncline[nodesepA=1mm,nodesepB=3mm,linewidth=1]{t}{null3}
\ncline[nodesepB=1mm]{n2}{null2}
\put(-60,60){\rnode{fig4}}
\put(-30,60){\rnode{fig5}}
\put(0,80){\rnode{null}{\makebox(0,0)[b]{\NULL}}}
\put(0,60){\mnode{n0}}
\put(10,40){\unode{n1}}
\put(-10,40){\mnode{n2}}
\put(-20,50){\rnode{p}{\makebox(0,0)[r]{$p$}}}
\put(20,20){\rnode{t}{\makebox(0,0)[l]{$t$}}}
\put(-20,20){\rnode{null2}{\makebox(0,0)[t]{\NULL}}}
\put(0,20){\rnode{null3}{\makebox(0,0)[t]{\NULL}}}
\put(5,30){\rnode{n11}}
\put(15,30){\rnode{n12}}
\ncline[linestyle=dotted]{-}{n1}{n11}
\ncline[linestyle=dotted]{-}{n1}{n12}
...
\ncline[nodesepB=1mm]{n2}{null2}
\ncline[nodesepB=1mm]{n2}{null3}
\ncarc[nodesepA=1mm,arcangleA=-10,arcangleB=-40,linewidth=1]{p}{n0}
\ncarc[nodesepA=1mm,linewidth=1]{t}{n2}
\ncarc[nodesepB=1mm,arcangleA=120,linewidth=1]{n0}{null}
...
\put(60,20){\rnode{null2}{\makebox(0,0)[t]{\NULL}}}
\put(80,20){\rnode{null3}{\makebox(0,0)[t]{\NULL}}}
\put(95,30){\rnode{n11}}
\put(85,30){\rnode{n12}}
\ncline[linestyle=dotted]{-}{n1}{n11}
\ncline[linestyle=dotted]{-}{n1}{n12}
...
\ncline[nodesepB=1mm]{n2}{null2}
\ncline[nodesepB=1mm]{n2}{null3}
\ncline[nodesepA=1mm,linewidth=1]{p}{n0}
\ncline[nodesepA=1mm,linewidth=1]{t}{n1}
\ncarc[nodesepB=1mm,arcangleA=-120,linewidth=1]{n0}{null}
...
In the version considered here, as in~\cite{bornat00mpc, mehta03cade}, we
assume that the nodes have at most two children\footnote{extension to an
arbitrary number of children is essentially the same, provided that this
number is bounded by a value $N$ ans that the $c$ field is large
...
the only memory allocated value is the $cons$ of lists.  In C,
these $cons$ structures can be defined as
\begin{alltt}
...
right child (they can be set to NULL). Fields $m$ and $c$ are integers
...
field $c$ is used internally, to denote which
of the children is currently being explored.
...
when the right child has been explored: the search goes back up.        


\subsection{Formal specification of the algorithm}
\label{sec:spec}

The first step in this formal verification process is to give a formal
...
graph. Indeed reasoning about reachability is the main part of this
...
annotations. 
%This is convenient for runtime assertion checking, but
%for formal verification it is not, because we need to reason (e.g.
%by induction) about reachability, not only compute with it. 
