...
Axiom num_of_pos_additive : forall (intP_intM_t_4_9_at_L:(Jessie_memory_model.memory
...
Axiom num_of_pos_increasing : forall (intP_intM_t_5_10_at_L:(Jessie_memory_model.memory
  intP int32)), forall (i_5:Z), forall (j_5:Z), forall (k_2:Z),
  forall (t_5:(Jessie_memory_model.pointer intP)), (j_5 <= k_2)%Z ->
  ((num_of_pos i_5 j_5 t_5 intP_intM_t_5_10_at_L) <= (num_of_pos i_5 k_2 t_5
  intP_intM_t_5_10_at_L))%Z.

Open Scope Z_scope.

(* Why3 goal *)
Theorem num_of_pos_strictly_increasing : forall (intP_intM_t_6_11_at_L:(Jessie_memory_model.memory
  intP int32)), forall (i_6:Z), forall (n:Z),
  forall (t_6:(Jessie_memory_model.pointer intP)), ((0%Z <= i_6)%Z /\
  ((i_6 <  n)%Z /\
  (0%Z <  (integer_of_int32 (Jessie_memory_model.select intP_intM_t_6_11_at_L
