...
(* Why3 goal *)
Theorem WP_parameter_my_exp_ensures_default : forall (x_0:floating_point.DoubleFormat.double),
  ((Rabs (floating_point.Double.value x_0)) <= 1%R)%R ->
  ((Rabs ((((09890365552 / 10000000000)%R + ((1130258690 / 1000000000)%R * (floating_point.Double.value x_0))%R)%R + (((05540440796 / 10000000000)%R * (floating_point.Double.value x_0))%R * (floating_point.Double.value x_0))%R)%R - (exp (floating_point.Double.value x_0)))%R) <= (65535 / 1048576)%R)%R.
intros x_0 h1.
interval with (i_bisect_diff (Double.value x_0)).
Qed.
