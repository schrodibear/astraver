...
Axiom num_of_pos_increasing : forall (intM_intP_t_5_20_at_L:(Jessie_memory_model.memory
  usObject int32)), forall (i_5:Z), forall (j_5:Z), forall (k_2:Z),
  forall (t_5:(Jessie_memory_model.pointer usObject)), (j_5 <= k_2)%Z ->
  ((num_of_pos i_5 j_5 t_5 intM_intP_t_5_20_at_L) <= (num_of_pos i_5 k_2 t_5
