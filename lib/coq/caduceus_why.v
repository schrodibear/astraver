...
(*Why predicate*) Definition not_assigns (A730:Set)
  (A729:Set) (a:alloc_table) (m1:(memory A729 A730)) (m2:(memory A729 A730))
  (l:(pset A730))
...
(*Why predicate*) Definition separation1 (A777:Set)
  (A776:Set) (m1:(memory (pointer A776) A777)) (m2:(memory (pointer A776)
  A777))
...
(*Why predicate*) Definition separation1_range1 (A779:Set)
  (A778:Set) (m1:(memory (pointer A778) A779)) (m2:(memory (pointer A778)
  A779)) (size:Z)
...
(*Why predicate*) Definition separation2 (A783:Set)
  (A782:Set) (m1:(memory (pointer A782) A783)) (m2:(memory (pointer A782)
  A783))
...
(*Why predicate*) Definition separation2_range1 (A785:Set)
  (A784:Set) (m1:(memory (pointer A784) A785)) (m2:(memory (pointer A784)
  A785)) (size:Z)
