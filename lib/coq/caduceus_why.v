...
(*Why predicate*) Definition valid (A699:Set) (a:alloc_table)
  (p:((pointer) A699)) := 0 <= (offset p) /\ (offset p) < (block_length a p).
...
(*Why predicate*) Definition separation2 (A800:Set)
  ...
  := (forall (p1:((pointer) A800)),
      (forall (p2:((pointer) A800)),
