...
Parameter of_int_modulo: Numbers.BinNums.Z -> Uint16.t.

Parameter of_int_const: Numbers.BinNums.Z -> Uint16.t.
...
Axiom Of_int_modulo : forall (n:Numbers.BinNums.Z),
  ((Uint16.to_int (of_int_modulo n)) = (normalize n)).

Axiom Add_modulo : forall (a:Uint16.t) (b:Uint16.t),
  ((Uint16.to_int (infix_plpc a
  b)) = (normalize ((Uint16.to_int a) + (Uint16.to_int b))%Z)).

Axiom Neg_modulo : forall (a:Uint16.t),
  ((Uint16.to_int (prefix_mnpc a)) = (normalize (-(Uint16.to_int a))%Z)).

Axiom Sub_modulo : forall (a:Uint16.t) (b:Uint16.t),
  ((Uint16.to_int (infix_mnpc a
  b)) = (normalize ((Uint16.to_int a) - (Uint16.to_int b))%Z)).

Axiom Mult_modulo : forall (a:Uint16.t) (b:Uint16.t),
  ((Uint16.to_int (infix_aspc a
  b)) = (normalize ((Uint16.to_int a) * (Uint16.to_int b))%Z)).

Axiom Div_modulo : forall (a:Uint16.t) (b:Uint16.t),
  ((Uint16.to_int (infix_slpc a
  b)) = (normalize (ZArith.BinInt.Z.quot (Uint16.to_int a) (Uint16.to_int b)))).

Axiom Mod_modulo : forall (a:Uint16.t) (b:Uint16.t),
  ((Uint16.to_int (infix_pcpc a
  b)) = (ZArith.BinInt.Z.rem (Uint16.to_int a) (Uint16.to_int b))).

Axiom Val_two_power_size : ((Powers_of_2.power2 16%Z) = ((65535%Z - 0%Z)%Z + 1%Z)%Z).

Axiom Of_int_const : forall (n:Numbers.BinNums.Z),
  ((of_int_const n) = (Uint16.of_int n)).

Axiom Of_int_def : forall (n:Numbers.BinNums.Z), (Uint16.in_bounds n) ->
...
Parameter nth: Uint16.t -> Numbers.BinNums.Z -> Prop.

Axiom Nth : forall (a:Uint16.t), forall (n:Numbers.BinNums.Z),
  ((0%Z <= n)%Z /\ (n < 16%Z)%Z) -> ((nth a n) <->
  ((((Uint16.to_int a) >= 0%Z)%Z /\
  ((ZArith.BinInt.Z.rem (Uint16.to_int a) (Powers_of_2.power2 (n + 1%Z)%Z)) >= (Powers_of_2.power2 n))%Z) \/
  (((Uint16.to_int a) < 0%Z)%Z /\
  ((ZArith.BinInt.Z.rem (((65535%Z - 0%Z)%Z + 1%Z)%Z + (Uint16.to_int a))%Z (Powers_of_2.power2 (n + 1%Z)%Z)) >= (Powers_of_2.power2 n))%Z))).

Axiom Nth_bw_and : forall (a:Uint16.t) (b:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= n)%Z /\ (n < 16%Z)%Z) -> ((nth
  (infix_et a b) n) <-> ((nth a n) /\ (nth b n))).

Axiom Nth_bw_or : forall (a:Uint16.t) (b:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= n)%Z /\ (n < 16%Z)%Z) -> ((nth
  (infix_brcf a b) n) <-> ((nth a n) \/ (nth b n))).

Axiom Nth_bw_xor : forall (a:Uint16.t) (b:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= n)%Z /\ (n < 16%Z)%Z) -> ((nth
  (infix_cf a b) n) <-> ~ ((nth a n) <-> (nth b n))).

Axiom Nth_bw_not : forall (a:Uint16.t), forall (n:Numbers.BinNums.Z),
  ((0%Z <= n)%Z /\ (n < 16%Z)%Z) -> ((nth (prefix_tl a) n) <-> ~ (nth a n)).

Axiom Lsr_nth_low : forall (b:Uint16.t), forall (s:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= (Uint16.to_int s))%Z /\
  ((Uint16.to_int s) < 16%Z)%Z) -> (((0%Z <= n)%Z /\ (n < 16%Z)%Z) ->
  (((n + (Uint16.to_int s))%Z < 16%Z)%Z -> ((nth (lsr b s) n) <-> (nth b
  (n + (Uint16.to_int s))%Z)))).

Axiom Lsr_nth_high : forall (b:Uint16.t), forall (s:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= (Uint16.to_int s))%Z /\
  ((Uint16.to_int s) < 16%Z)%Z) -> (((0%Z <= n)%Z /\ (n < 16%Z)%Z) ->
  (((n + (Uint16.to_int s))%Z >= 16%Z)%Z -> ~ (nth (lsr b s) n))).

Axiom Asr_nth_low : forall (b:Uint16.t), forall (s:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= (Uint16.to_int s))%Z /\
  ((Uint16.to_int s) < 16%Z)%Z) -> (((0%Z <= n)%Z /\ (n < 16%Z)%Z) ->
...
Axiom Asr_nth_high : forall (b:Uint16.t), forall (s:Uint16.t),
  forall (n:Numbers.BinNums.Z), ((0%Z <= (Uint16.to_int s))%Z /\
  ((Uint16.to_int s) < 16%Z)%Z) -> (((0%Z <= n)%Z /\ (n < 16%Z)%Z) ->
  (((n + (Uint16.to_int s))%Z >= 16%Z)%Z -> ((nth (asr b s) n) <-> (nth b
  (16%Z - 1%Z)%Z)))).
...
Axiom Lsl : forall (b:Uint16.t), forall (s:Uint16.t),
  ((0%Z <= (Uint16.to_int s))%Z /\ ((Uint16.to_int s) < 16%Z)%Z) ->
  (((lsr (lsl_modulo b s) s) = s) -> ((lsl b s) = (lsl_modulo b s))).

Axiom Lsr_unsigned : forall (a:Uint16.t), forall (n:Uint16.t),
  ((0%Z <= (Uint16.to_int n))%Z /\ ((Uint16.to_int n) < 16%Z)%Z) ->
  ((Uint16.to_int (lsr a n)) = (int.EuclideanDivision.div (Uint16.to_int a)
  (Powers_of_2.power2 (Uint16.to_int n)))).

Axiom Asr_signed : True.

Axiom Lsl_modulo : forall (a:Uint16.t), forall (n:Uint16.t),
  ((0%Z <= (Uint16.to_int n))%Z /\ ((Uint16.to_int n) < 16%Z)%Z) ->
  ((Uint16.to_int (lsl_modulo a
  n)) = (normalize ((Uint16.to_int a) * (Powers_of_2.power2 (Uint16.to_int n)))%Z)).
