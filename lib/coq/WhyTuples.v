...
(* $Id: WhyTuples.v,v 1.4 2003-09-22 13:11:59 filliatr Exp $ *)
...
Implicit Arguments exist_4 [1 2 3 4].
...
Implicit Arguments exist_5 [1 2 3 4 5].
...
Implicit Arguments exist_6 [1 2 3 4 5 6].
...
Implicit Arguments exist_7 [1 2 3 4 5 6 7].
...
(P:T1 -> T2 -> T3 -> T4 -> T5 -> T6 -> T7 -> T8 -> Prop) : Set :=
    exist_8 :
      ...
      Implicit Arguments exist_8 [1 2 3 4 5 6 7 8].
