...
public class SCID extends Applet {
  ...
  final static byte    ADMINPIN_SIZE          = (byte) 3;   // size of the PIN in byte
    //@ static invariant DEFAULT_ADMINPIN_inv: DEFAULT_ADMINPIN != null && DEFAULT_ADMINPIN.length == ADMINPIN_SIZE;
  ...
  final static byte    USERPIN_SIZE          = (byte) 2;    // size of the PIN in byte
    //@ static invariant DEFAULT_USERPIN_inv: DEFAULT_USERPIN != null && DEFAULT_USERPIN.length == USERPIN_SIZE;
  ...
  final static byte    USERPIN_ID            = (byte) 1;    // PIN identifier, PIN 1 = user PIN
	...
	= {(byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
	   (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00};
    //@ static invariant DEFAULT_AUTHKEY_inv: DEFAULT_AUTHKEY != null && DEFAULT_AUTHKEY.length == 8;
  ...
  private void cmdSELECT(APDU apdu) {
    ...
    short lc = cmd_apdu[ISO7816.OFFSET_LC];  // get Lc (command length)
    apdu.setIncomingAndReceive();                                  // get the command body
  ...
  private void cmdPUTDATA(APDU apdu) {
    ...
    switch(tag) {
      case TAG_USERPIN:
        ...
        Util.arrayCopy(cmd_apdu, ISO7816.OFFSET_CDATA, workarray, (short) 0, lc);
      ...
      case TAG_SCID:
        ...
        Util.arrayCopy(cmd_apdu, ISO7816.OFFSET_CDATA, scid, (short) 0, lc);
        break;
    default :
