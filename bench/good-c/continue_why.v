...
Definition f1 (* validation *)
  : (_: unit)(sig_1 Z [result: Z](`result = 0`))
  := [_: unit]
                       ...
                       let (n1, result1, Post9) =
                         let (n1, result1, Post10) =
                           let (result1, Bool1) =
                             ...
                             (if result4 then `n0 = 5` else `n0 <> 5`) 
                             result3 Post11) in
                           (Cases (btest
                           ...
                           | (left Test3) =>
                                 ...
                                 let (result3, Post14) =
                                   (exist_1 (qcomb [result3: unit]
                                             ...
                                             [result3: unit]False) (Exn unit
                                                                    tt)
                                   (f1_po_1 result Post4 Variant1 n0 Pre3
                               ...
                               | (Qexn _0 Post5) => (exist_2 [n2: Z]
                                 (qcomb [result3: unit]`0 <= n2` /\
                                  ...
                                  ((n:Z)
                                   (n = `n2 - 1` -> `0 <= n` /\
                                    (Zwf `0` n n0)))) n1 (Exn unit tt) Post5)
                               end
                           | (right Test2) =>
                               let (result2, Post12) =
...
Definition f2 (* validation *)
  : (_: unit)(sig_1 Z [result: Z](`result = 10`))
  := [_: unit]
                       ...
                       let (i2, result2, Post10) =
                         let (i2, result2, Post11) =
                           let (result2, Bool1) =
                             ...
                             (if result5 then `i1 = 5` else `i1 <> 5`) 
                             result4 Post12) in
                           (Cases (btest
                           ...
                           | (right Test2) =>
                               let (result3, Post13) =
                                 ...
                                 ((i:Z)
                                  (i = `i1 + 1` -> `i <= 10` /\
                                   (Zwf `0` `10 - i` `10 - i1`))) tt
                                 (f2_po_2 result Post5 i0 Post1 Variant1 i1
