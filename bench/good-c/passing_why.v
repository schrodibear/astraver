...
Definition g (* validation *)
  : (x: Z)(sig_2 Z unit [x0: Z][result: unit](`x0 = 0`))
  := [x: Z]
...
Definition g2 (* validation *)
  : (_: unit)(r: Z)(sig_2 Z Z [r0: Z][result: Z](`result = 0`))
  := [_: unit; r: Z]
       let (r0, result, Post1) =
...
Definition g3 (* validation *)
  ...
  := [_: unit]
       ...
       let (i0, result0, Post2) =
         ...
         let (result1, Post5) = (exist_1 [result1: Z]`result1 = 0` i0
           Post3) in
...
Definition f (* validation *)
  : (x: (array Z))(_: `(array_length x) = 1`)
    (sig_2 (array Z) unit [x0: (array Z)][result: unit](`(access x0 0) = 1`))
...
Definition main (* validation *)
  : (_: unit)(t: (array Z))(_: `(array_length t) = 1`)
    (sig_2 (array Z) unit [t0: (array Z)][result: unit](`(access t0 0) = 1`))
  := [_: unit; t: (array Z); Pre2: `(array_length t) = 1`]
       let Pre1 = Pre2 in
       let (t0, result0, Post1) = (f t Pre1) in
       (exist_2 [t1: (array Z)][result1: unit]`(access t1 0) = 1` t0 
       result0 Post1).
