...
Definition f := (* validation *)
  [y: Z; ddd: Z; z: Z; Pre1: `y = ddd`]
    ...
    let (u0, result0, Post4) =
      let (aux_1, Post2) = (exist_1 [result0: Z]result0 = result result
      ...
      let (u0, result0, Post5) =
        ...
        let (result1, Post6) = (exist_1 [result1: Z]`result1 = z` aux_1
          (f_po_1 y ddd z Pre1 result Post3 aux_1 Post2 u0 Post1)) in
    ...
    let (x1, result0, Post3) =
      let (x1, result0, Post4) =
        let (x1, aux_2, Post5) =
          ...
          x1 result1 Post6) in
        let Pre3 = (main_po_2 x0 Post1 aux_2 Post5) in
        let (result0, Post7) =
          let Pre1 = Pre3 in
          let Pre2 = Pre1 in
          let (result2, Post8) = (f `1` aux_2 `2` Pre1) in
