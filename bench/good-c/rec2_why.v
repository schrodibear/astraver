    ...
    (well_founded_induction Z (Zwf ZERO) (Zwf_well_founded `0`) [Variant1: Z]
      ...
      [Variant1: Z; wf1: (Variant2: Z)(Pre1: (Zwf `0` Variant2 Variant1))
       ...
       Pre6: `x0 >= 0`]
        let (result, Post2) =
            ...
            | (left Test2) =>
                let (result0, Post6) =
                  ...
                  (exist_1 (qcomb [result1: Z]`result1 = 0` [result1: unit]
                            False) (Exn unit result0)
                  Post7) in
                Cases (decomp1 Post6) of
                | (Qval (exist result1 Post8)) =>
                  (exist_1 (qcomb [result2: Z]`result2 = 0` [result2: unit]
          ...
          | (Qval (exist result0 Post10)) =>
            ...
            let (result1, Post12) =
              ...
              let (result3, Post13) =
                ((wf1 `x0 - 1`)
                  (f_po_3 x Pre8 Variant1 x0 Pre7 Pre6 Post10 Pre5 Pre3 Pre4)
        ...
        | (Qexn result0 Post15) =>
          let (result1, Post16) = (exist_1 [result1: Z]`result1 = 0` 
            result0 Post15) in
