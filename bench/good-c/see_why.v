...
(* Why obligation from file "see.c", characters 122-123 *)
Lemma f_po_1 : 
  (b: Z)
  (b0: Z)
  (Post1: b0 = `1 - b`)
...
(* Why obligation from file "see.c", characters 196-203 *)
Lemma k_po_1 : 
  (b0: Z)
  (Post1: b0 = `1`)
  (b3: Z)
...
(* Why obligation from file "see.c", characters 214-221 *)
Lemma k_po_2 : 
  (b0: Z)
  (Post1: b0 = `1`)
  (b4: Z)
...
(* Why obligation from file "see.c", characters 213-228 *)
Lemma k_po_3 : 
  (b0: Z)
  (Post1: b0 = `1`)
  (b4: Z)
               ...
               ((b:Z)
                (`result = b` /\ `b = 1 - b4` ->
                 ((result1:Z)
                  ((b0:Z)
                   (`result1 = b0` /\ `b0 = 1 - b` ->
                    `c_aux_1 + result0 = 0` /\ `(1 - result) * result1 = 1`)))))) 
              `1 - c_aux_2`
              (k_po_1 b0 Post1 b3 c_aux_1 Post4 b4 c_aux_2 Post8)) in
             ...
             ((b:Z)
              (`result = b` /\ `b = 1 - b5` ->
               ((result0:Z)
                ((b0:Z)
                 (`result0 = b0` /\ `b0 = 1 - b` ->
                  `c_aux_1 + result1 = 0` /\ `(1 - result) * result0 = 1`)))))) 
               ...
               ((result1:Z)
                ((b0:Z)
                 (`result1 = b0` /\ `b0 = 1 - b` -> `result0 = 0` /\
                  `(1 - result) * result1 = 1`)))))) `c_aux_1 + c_aux_3`
            Post7) in
          (exist_2 [b5: Z][result1: Z]
          ((result:Z)
           ((b:Z)
         ...
         ((result0:Z)
          ((b0:Z)
           (`result0 = b0` /\ `b0 = 1 - b` -> `b5 = 0` /\
            `(1 - result) * result0 = 1`)))))) b3
      result0 tt Post3) in
    let (b6, b5, result1, Post12) =
      let (b5, result1, Post13) =
        let (b5, c_aux_5, Post14) =
          let (b5, c_aux_4, Post15) =
          ...
          let (result1, Post17) = (exist_1 [result1: Z]
            ((result:Z)
             ((b:Z)
              (`result = b` /\ `b = 1 - b5` -> `b3 = 0` /\
               `result1 * result = 1`))) `1 - c_aux_4`
            (k_po_2 b0 Post1 b4 b3 Post2 b5 c_aux_4 Post15)) in
        ...
        let (b6, result1, Post18) =
          ...
          let (result1, Post21) = (exist_1 [result1: Z]`b3 = 0` /\
            `result1 = 1` `c_aux_5 * c_aux_6`
            (k_po_3 b0 Post1 b4 b3 Post2 b5 c_aux_5 Post14 b6 c_aux_6 Post19)) in
          (exist_2 [b7: Z][result2: Z]`b3 = 0` /\ `result2 = 1` b6 result1
          Post21) in
        (exist_2 [b7: Z][result2: Z]`b3 = 0` /\ `result2 = 1` b6 result1
        Post18) in
      (exist_3 [b8: Z][b7: Z][result2: unit]`b3 = 0` /\ `b7 = 1` b5 result1
      tt Post13) in
