...
Definition p1 (* validation *)
  ...
  := (exist_1 fun (result: Z) => True 0 I).

Definition p2 (* validation *)
  : (sig_1 Z (fun (result: Z)  => (~False)))
  := (exist_1 fun (result: Z) => ~False 0 p2_po_1).

Definition p3 (* validation *)
  : (sig_1 Z (fun (result: Z)  => (True /\ True)))
  := (exist_1 fun (result: Z) => True /\ True 0 p3_po_1).

Definition p4 (* validation *)
  : (sig_1 Z (fun (result: Z)  => (True \/ False)))
  := (exist_1 fun (result: Z) => True \/ False 0 p4_po_1).

Definition p5 (* validation *)
  : (sig_1 Z (fun (result: Z)  => (False \/ ~False)))
  := (exist_1 fun (result: Z) => False \/ ~False 0 p5_po_1).

Definition p6 (* validation *)
  : (sig_1 Z (fun (result: Z)  => ((True -> ~False))))
  := (exist_1 fun (result: Z) => (True -> ~False) 0 p6_po_1).

Definition p7 (* validation *)
  : (sig_1 Z (fun (result: Z)  => ((forall (x:Z), x = x))))
  := (exist_1 fun (result: Z) => (forall (x:Z), x = x) 0 p7_po_1).

Definition p8 (* validation *)
  : (sig_1 Z (fun (result: Z)  => (True /\ (forall (x:Z), x = x))))
  := (exist_1 fun (result: Z) => True /\ (forall (x:Z), x = x) 0 p8_po_1).

Definition p9 (* validation *)
  : (sig_1 Z
     (fun (result: Z)  => ((forall (x:Z), (forall (y:Z), (x = y -> x = y))))))
  := (exist_1 fun (result: Z) =>
     (forall (x:Z), (forall (y:Z), (x = y -> x = y))) 0 p9_po_1).
...
Definition a1 (* validation *)
  : forall (v4: Z),
    (sig_2 Z unit (fun (v4_0: Z) (result: unit)  => (v4_0 = 1)))
  := [v4: Z]
       let (result, Post1) = (exist_1 fun (result: Z) => result = 1 1
         (refl_equal ? 1)) in
       (exist_2 fun (v4_1: Z) => fun (result0: unit) => v4_1 = 1 result 
       tt Post1).

Definition a2 (* validation *)
  : forall (v1: bool),
    (sig_2 bool unit (fun (v1_0: bool) (result: unit)  => (v1_0 = true)))
  := [v1: bool]
       let (result, Post1) = (exist_1 fun (result: bool) =>
         result = true true (refl_equal ? true)) in
       (exist_2 fun (v1_1: bool) => fun (result0: unit) => v1_1 = true 
       result tt Post1).

Definition a3 (* validation *)
  : forall (v4: Z),
    (sig_2 Z unit (fun (v4_0: Z) (result: unit)  => (v4_0 = 2 + 2)))
  := [v4: Z]
       let (result, Post1) = (exist_1 fun (result: Z) => result = 2 + 2 
         2 + 2 (refl_equal ? 2 + 2)) in
       (exist_2 fun (v4_1: Z) => fun (result0: unit) => v4_1 = 2 + 2 
       result tt Post1).
...
Definition a4 (* validation *)
  ...
  := [v4: Z]
       let (result, Post1) = (exist_1 fun (result: Z) => result = v4 
         v4 (refl_equal ? v4)) in
       (exist_2 fun (v4_1: Z) => fun (result0: unit) => v4_1 = v4 result 
       tt Post1).

Definition s1 (* validation *)
  : forall (v4: Z), (tuple_2 Z unit)
  := [v4: Z]
       let (v4_0, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: Z) => result = 1 
           1 (refl_equal ? 1)) in
         (exist_2 fun (v4_1: Z) => fun (result0: unit) => v4_1 = 1 result 
         tt Post1) in
       let (v4_1, result0, Post2) =
         let (result0, Post2) = (exist_1 fun (result0: Z) => result0 = 2 
           2 (refl_equal ? 2)) in
         (exist_2 fun (v4_2: Z) => fun (result1: unit) => v4_2 = 2 result0 
         tt Post2) in
       (Build_tuple_2 v4_1 result0).

Definition s2 (* validation *)
  : forall (v1: bool), forall (v4: Z), (tuple_3 bool Z unit)
  := [v1: bool; v4: Z]
       let (v1_0, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: bool) =>
           result = true true (refl_equal ? true)) in
         (exist_2 fun (v1_1: bool) => fun (result0: unit) =>
         v1_1 = true result tt Post1) in
       let (v4_0, result0, Post2) =
         let (result0, Post2) = (exist_1 fun (result0: Z) => result0 = 2 
           2 (refl_equal ? 2)) in
         (exist_2 fun (v4_1: Z) => fun (result1: unit) => v4_1 = 2 result0 
         tt Post2) in
...
Definition s3 (* validation *)
  ...
  := [v4: Z]
       let (v4_0, result, Post1) =
         ...
         tt Post1) in
       let (v4_1, result0, Post2) =
         let (result0, Post2) = (exist_1 fun (result0: Z) =>
           result0 = v4_0 v4_0 (refl_equal ? v4_0)) in
         (exist_2 fun (v4_2: Z) => fun (result1: unit) => v4_2 = v4_0 
         result0 tt Post2) in
       let (v4_2, result1, Post3) =
         let (result1, Post3) = (exist_1 fun (result1: Z) => result1 = 3 
           3 (refl_equal ? 3)) in
         (exist_2 fun (v4_3: Z) => fun (result2: unit) => v4_3 = 3 result1 
         tt Post3) in
       (Build_tuple_2 v4_2 result1).

Definition s4 (* validation *)
  : forall (v4: Z), (tuple_2 Z Z)
  := [v4: Z]
       let (v4_0, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: Z) => result = 1 
           1 (refl_equal ? 1)) in
  ...
  := [v4: Z]
       ...
       | (left Test2) =>
           let (v4_0, result0, Post1) =
             let (result0, Post1) = (exist_1 fun (result0: Z) =>
               result0 = 2 2 (refl_equal ? 2)) in
             (exist_2 fun (v4_1: Z) => fun (result1: unit) =>
             v4_1 = 2 result0 tt Post1) in
           (Build_tuple_2 v4_0 result0)
       | (right Test1) =>
           let (v4_0, result0, Post2) =
             let (result0, Post2) = (exist_1 fun (result0: Z) =>
               result0 = 3 3 (refl_equal ? 3)) in
             (exist_2 fun (v4_1: Z) => fun (result1: unit) =>
             v4_1 = 3 result0 tt Post2) in
           (Build_tuple_2 v4_0 result0) end.

Definition l1 (* validation *)
  : Z
  := let (x, Post1) = (exist_1 fun (result: Z) => result = 1 1
       (refl_equal ? 1)) in
     x.
...
Definition l2 (* validation *)
  : forall (v4: Z), (tuple_2 Z unit)
  := [v4: Z]
       let (x, Post2) = (exist_1 fun (result: Z) => result = 1 1
         (refl_equal ? 1)) in
       let (v4_0, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: Z) => result = x 
           x (refl_equal ? x)) in
         (exist_2 fun (v4_1: Z) => fun (result0: unit) => v4_1 = x result 
         tt Post1) in
...
Definition l3 (* validation *)
  ...
  := let (x, Post2) = (exist_1 fun (result: Z) => result = 1 1
       (refl_equal ? 1)) in
     let result =
       let (y, Post1) = (exist_1 fun (result: Z) => result = 2 2
         (refl_equal ? 2)) in
       x + y in
     result.
...
Definition l5 (* validation *)
  : forall (v1: bool), forall (v4: Z), (tuple_3 bool Z unit)
  := [v1: bool; v4: Z]
       let (x, Post3) = (exist_1 fun (result: Z) => result = 1 1
         (refl_equal ? 1)) in
       let (v1_0, v4_0, result) =
         let (v1_0, result, Post1) =
           ...
           v1_1 = true result tt Post1) in
         let (v4_0, result0, Post2) =
           let (result0, Post2) = (exist_1 fun (result0: Z) => result0 = x 
             x (refl_equal ? x)) in
           (exist_2 fun (v4_1: Z) => fun (result1: unit) => v4_1 = x 
           result0 tt Post2) in
...
Definition lr1 (* validation *)
  ...
  := let (x, Post2) = (exist_1 fun (result: Z) => result = 1 1
     ...
     let (x1, result, Post1) =
       let (result, Post1) = (exist_1 fun (result: Z) => result = 2 2
         (refl_equal ? 2)) in
       (exist_2 fun (x2: Z) => fun (result0: unit) => x2 = 2 result tt Post1) in
     result.
...
Definition lr2 (* validation *)
  ...
  := let (x, Post2) = (exist_1 fun (result: Z) => result = 1 1
     ...
     let (x1, result) =
       let (x1, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: Z) =>
           result = x + 1 x + 1 (refl_equal ? x + 1)) in
         (exist_2 fun (x2: Z) => fun (result0: unit) => x2 = x + 1 result 
         tt Post1) in
...
Definition lr3 (* validation *)
  ...
  := let (x, Post3) = (exist_1 fun (result: Z) => result = 1 1
       (refl_equal ? 1)) in
     let (x1, result) =
       let (y, Post2) = (exist_1 fun (result: Z) => result = x x
         (refl_equal ? x)) in
       let (x1, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: Z) => result = y 
           y (refl_equal ? y)) in
         (exist_2 fun (x2: Z) => fun (result0: unit) => x2 = y result 
         tt Post1) in
       (Build_tuple_2 x1 result) in
     result.

Definition r1 (* validation *)
  : (sig_1 bool (fun (result: bool)  => ((if result then 1 = 1 else 1 <> 1))))
  := let (result1, Post1) = (Z_eq_bool 1 1) in
     (exist_1 fun (result2: bool) =>
     (if result2 then 1 = 1 else 1 <> 1) result1 Post1).

Definition r2 (* validation *)
  : (sig_1 bool (fun (result: bool)  => ((if result then 2 > 1 else 2 <= 1))))
  := let (result1, Post1) = (Z_gt_le_bool 2 1) in
     (exist_1 fun (result2: bool) =>
     (if result2 then 2 > 1 else 2 <= 1) result1 Post1).
...
Definition r4 (* validation *)
  : (sig_1 bool (fun (result: bool)  => ((if result then 1 < 2 else 1 >= 2))))
...
Definition r7 (* validation *)
  ...
  := let (result, Bool1) =
     ...
     Cases
       (btest [result:bool](if result then 1 = 2 else 1 <> 2) result Bool1) of
     | (left Test2) => true
     | (right Test1) =>
         let (result0, Post2) =
...
Definition arr4 (* validation *)
  : forall (v6: (array Z)), forall (_: (array_length v6) >= 10 /\
    (access v6 0) = 9), Z
...
Definition arr5 (* validation *)
  : forall (v6: (array Z)), forall (_: (array_length v6) >= 1),
    (sig_2 (array Z) unit
     (fun (v6_0: (array Z)) (result: unit)  => (v6_0 = (store v6 0 1))))
  := [v6: (array Z); Pre2: (array_length v6) >= 1]
       let Pre1 = (arr5_po_1 v6 Pre2) in
       (exist_2 fun (v6_1: (array Z)) => fun (result1: unit) =>
       v6_1 = (store v6 0 1) (store v6 0 1) tt (refl_equal ? (store v6 0 1))).

Definition arr6 (* validation *)
  : forall (v6: (array Z)), forall (_: (array_length v6) >= 4),
    (sig_2 (array Z) unit
     (fun (v6_0: (array Z)) (result: unit)  =>
...
Definition arr7 (* validation *)
  ...
  := [v6: (array Z); Pre3: (array_length v6) >= 10 /\ (access v6 0) = 9]
       ...
       (exist_2 fun (v6_1: (array Z)) => fun (result1: unit) =>
       v6_1 = (store v6 (access v6 0) 1) (store v6 (access v6 0) 1) tt
       (refl_equal ? (store v6 (access v6 0) 1))).
...
Definition fc3 (* validation *)
  : Z
  := let (a, Post2) = (exist_1 fun (result: Z) => result = 0 0
       (refl_equal ? 0)) in
     let result =
       let (b, Post1) = (exist_1 fun (result: Z) => result = 0 0
         (refl_equal ? 0)) in
       ...
       let (b1, result, Post3) =
         ...
         (exist_2 fun (b2: Z) => fun (result0: Z) => b2 = b + a + result0 
         b1 r Post4) in
       result in
     result.

Definition an1 (* validation *)
  : (sig_1 Z (fun (result: Z)  => (result = 0)))
  := (exist_1 fun (result: Z) => result = 0 0 (refl_equal ? 0)).

Definition an2 (* validation *)
  : forall (v4: Z), forall (_: v4 >= 0),
    (sig_2 Z unit (fun (v4_0: Z) (result: unit)  => (v4_0 > v4)))
  := [v4: Z; Pre1: v4 >= 0]
       let (v4_0, result, Post1) =
         let (result, Post1) = (exist_1 fun (result: Z) =>
           result = v4 + 1 v4 + 1 (refl_equal ? v4 + 1)) in
         (exist_2 fun (v4_1: Z) => fun (result0: unit) =>
         v4_1 = v4 + 1 result tt Post1) in
       (exist_2 fun (v4_1: Z) => fun (result0: unit) => v4_1 > v4 v4_0 
       result (an2_po_1 v4 Pre1 v4_0 Post1)).
