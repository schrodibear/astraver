...
Definition l2 := (* validation *)
  [v4: Z]
    ...
    let (v9, result0, Post2) =
      ...
      (exist_2 [v10: Z][result1: unit]v10 = result result0 tt Post2) in
    (Build_tuple_2 v9 result0).
...
Definition l5 := (* validation *)
  [v1: bool]
    [v4: Z]
      ...
      let (v10, v9, result0) =
        let (v9, result0, Post2) =
          let (result0, Post2) = (exist_1 [result0: bool]result0 = true 
            true (refl_equal ? true)) in
          (exist_2 [v10: bool][result1: unit]v10 = true result0 tt Post2) in
        let (v10, result1, Post3) =
          let (result1, Post3) = (exist_1 [result1: Z]result1 = result 
            result (refl_equal ? result)) in
          (exist_2 [v11: Z][result2: unit]v11 = result result1 tt Post3) in
        (Build_tuple_3 v9 v10 result1) in
      (Build_tuple_3 v10 v9 result0).
...
Definition lr2 := (* validation *)
  ...
  let (x0, result0) =
    let (x0, result0, Post2) =
      let (result0, Post2) =
        (exist_1 [result0: Z]result0 = `result + 1` `result + 1`
...
Definition r7 := (* validation *)
  ...
  | (right Test1) =>
      let (result0, Post2) =
        ...
        (exist_1 [result3: bool](if result3 then `2` = `3` else ~(`2` = `3`)) 
        result2 Post3) in
      result0 end).
...
Definition arr3 := (* validation *)
  [v4: Z]
    [v6: (array `10` Z)]
      [Pre2: v4 = `0`]let Pre1 = (arr3_po_1 v4 Pre2) in
                      (access v6 v4).
...
Definition arr5 := (* validation *)
  [v6: (array `10` Z)]
    let (result, Post1) =
      (exist_1 [result: Z](store v6 `0` result) = (store v6 `0` `1`) 
      `1` (refl_equal ? (store v6 `0` `1`))) in
    let Pre1 = (arr5_po_1 v6 result Post1) in
    (exist_2 [v10: (array `10` Z)][result1: unit]v10 = (store v6 `0` `1`) 
    (store v6 `0` result) tt Post1).
...
Definition arr6 := (* validation *)
  [v6: (array `10` Z)]
    let (result, Post1) =
      (exist_1 [result: Z](store v6 `1 + 2` result) =
                          (store v6 `1 + 2` `3 + 4`) `3 + 4`
      (refl_equal ? (store v6 `1 + 2` `3 + 4`))) in
    let Pre1 = (arr6_po_1 v6 result Post1) in
    (exist_2 [v10: (array `10` Z)][result1: unit]v10 =
                                                 (store v6 `1 + 2` `3 + 4`) 
    (store v6 `1 + 2` result) tt Post1).
...
Definition arr7 := (* validation *)
  [v6: (array `10` Z)]
    [Pre3: (access v6 `0`) = `9`]
      ...
      let (result, Post1) =
        (exist_1 [result: Z](store v6 (access v6 `0`) result) =
                            (store v6 (access v6 `0`) `1`) `1`
        (refl_equal ? (store v6 (access v6 `0`) `1`))) in
      let Pre1 = (arr7_po_2 v6 Pre3 Pre2 result Post1) in
      (exist_2 [v10: (array `10` Z)][result1: unit]v10 =
                                                   (store v6 (access v6 `0`)
                                                    `1`) (store v6
                                                          (access v6 `0`)
                                                          result)
      tt Post1).
