...
Definition p6 := (* validation *)
  let (result, Post1) = (exist_1 [result: Z]result = `3` `3`
    (refl_equal ? `3`)) in
  let (result0, Post2) = (exist_1 [result0: Z]result0 = `7` `result + 4`
    (p6_po_1 result Post1)) in
  (exist_1 [result1: Z]result1 = `7` result0 Post2).
...
Definition p7 := (* validation *)
  let (result, Post2) =
    let (result, Post1) = (exist_1 [result: Z]result = `4` `4`
      (refl_equal ? `4`)) in
    let (result0, Post3) =
      (exist_1 [result0: Z]`3 + result0` = `11` `result + result`
      (p7_po_1 result Post1)) in
    (exist_1 [result1: Z]`3 + result1` = `11` result0 Post3) in
  let (result0, Post4) = (exist_1 [result0: Z]result0 = `11` `3 + result`
    Post2) in
  (exist_1 [result1: Z]result1 = `11` result0 Post4).
  ...
  [x: Z]
    [Pre1: (q `x + 1`)]
      let (x0, result, Post2) =
        ...
        x0 result0 Post3) in
      let (result0, Post4) = (exist_1 [result0: Z](q x0) /\
        result0 = `x + 4` `3 + result` Post2) in
      (exist_2 [x1: Z][result1: Z](q x1) /\ result1 = `x + 4` x0 result0
      Post4).
...
Definition p9 := (* validation *)
  [x: Z]
    let (x0, result, Post3) =
      ...
      let (result0, Post4) =
        (exist_1 [result0: Z]((x:Z)
                              (x = `1` -> `1 + result0` = `2` /\ x = `1`)) 
        `1` (p9_po_1 x0 Post2)) in
      (exist_2 [x1: Z][result1: Z]((x:Z)
                                   (x = `1` -> `1 + result1` = `2` /\ x = `1`)) 
      x0 result0 Post4) in
    let (x1, result0, Post5) =
      let (x1, result0, Post6) =
        let (x1, result0, Post1) =
          let (result0, Post1) = (exist_1 [result0: Z]result0 = `1` `1`
            (refl_equal ? `1`)) in
          (exist_2 [x2: Z][result1: unit]x2 = `1` result0 tt Post1) in
        let (result1, Post7) =
          (exist_1 [result1: Z]`result1 + result` = `2` /\ x1 = `1` `1`
          (p9_po_2 result Post3 x1 Post1)) in
        (exist_2 [x2: Z][result2: Z]`result2 + result` = `2` /\ x2 = `1` 
        x1 result1 Post7) in
      let (result1, Post8) = (exist_1 [result1: Z]result1 = `2` /\
        x1 = `1` `result0 + result` Post6) in
...
Definition p11 := (* validation *)
  ...
  let (result0, Post3) =
    let (result0, Post4) =
      let (result2, Post5) = (fsucc `0`) in
      (exist_1 [result3: Z]result3 = `0 + 1` result2 Post5) in
    let (result1, Post6) =
      (exist_1 [result1: Z]result1 = `5` `result0 + result`
      (p11_po_1 result Post1 result0 Post4)) in
    (exist_1 [result2: Z]result2 = `5` result1 Post6) in
  (exist_1 [result1: Z]result1 = `5` result0 Post3).
...
Definition p11a := (* validation *)
  ...
  let (result0, Post3) = (exist_1 [result0: Z]result0 = `4` `result + result`
    (p11a_po_1 result Post1)) in
  (exist_1 [result1: Z]result1 = `4` result0 Post3).
...
Definition p13a := (* validation *)
  [x: Z]
    let (x0, result, Post1) =
      ...
      (exist_2 [x1: Z][result2: unit]x1 = `x + 1` x0 result1 Post2) in
    let (x1, result0, Post3) =
      let (x1, result2, Post4) = (incrx result x0) in
      (exist_2 [x2: Z][result3: unit]x2 = `x0 + 1` x1 result2 Post4) in
    (exist_2 [x2: Z][result1: unit]x2 = `x + 2` x1 result0
...
Definition p16 := (* validation *)
  [t: (array `10` Z)]
    let (result, Post1) =
      (exist_1 [result: Z](store t `9` result) = (store t `9` `1`) `1`
      (refl_equal ? (store t `9` `1`))) in
    let Pre1 = (p16_po_1 t result Post1) in
    (exist_2 [t1: (array `10` Z)][result1: unit]t1 = (store t `9` `1`) 
    (store t `9` result) tt Post1).
...
Definition p17 := (* validation *)
  [t: (array `10` Z)]
    [Pre3: `0 <= (access t 0)` /\ `(access t 0) < 10`]
      ...
      let (result, Post1) =
        (exist_1 [result: Z](store t (access t `0`) result) =
                            (store t (access t `0`) `1`) `1`
        (refl_equal ? (store t (access t `0`) `1`))) in
      let Pre1 = Pre3 in
      (exist_2 [t1: (array `10` Z)][result1: unit]t1 =
                                                  (store t (access t `0`) `1`) 
      (store t (access t `0`) result) tt Post1).
