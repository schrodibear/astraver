       ...
       Pre5: Variant1 = `10 - i0`; Pre4: `i0 <= 10`]
        ...
        | (left Test2) =>
            ...
            let (i1, result0, Post5) =
              let (i1, result0, Post2) =
                ...
                (loop1_po_1 i Pre6 Variant1 i0 Pre5 Pre4 Test2 Pre3 i1 Post1)) in
              ((wf1 `10 - i1`)
                (loop1_po_2 i Pre6 Variant1 i0 Pre5 Pre4 Test2 Pre3 i1 Post2)
        ...
        | (right Test1) =>
            ...
            let (i1, result0, Post4) = (exist_2 [i1: Z][result0: unit]
              `i1 = 10` i0 tt
              (loop1_po_3 i Pre6 Variant1 i0 Pre5 Pre4 Test1 Pre2)) in
  ...
  [x: Z; Pre4: `x <= 10`]
         ...
         Pre3: Variant1 = `10 - x0`; Pre2: `x0 <= 10`]
          ...
          | (left Test2) =>
              let (x1, result0, Post7) =
                ...
                ((wf1 `10 - x1`)
                  (loop2_po_2 x Pre4 Variant1 x0 Pre3 Pre2 Test2 x1 Post3) 
          ...
          | (right Test1) =>
              let (x1, result0, Post6) = (exist_2 [x1: Z][result0: unit]
                `x1 = 10` x0 tt
                (loop2_po_3 x Pre4 Variant1 x0 Pre3 Pre2 Test1)) in
    ...
    let (x1, result0, Post8) =
      ...
      | (left Test4) =>
          ...
          (loop2_po_4 x Pre4 x0 Post4 Test4 x1 Post11))
      | (right Test3) =>
          let (result1, Post10) = (exist_1 [result1: unit]`x0 = (-10)` 
            tt (loop2_po_5 x Pre4 x0 Post4 Test3)) in
