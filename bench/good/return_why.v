  ...
  [i: Z; t: (array N Z)]
    let (i0, result, Post6) =
      ...
      let (i1, result0, Post7) =
        (well_founded_induction Z (Zwf ZERO) (p_po_1 i0 Post1) [Variant1: Z]
          (i1: Z)(_: Variant1 = `N - i1`)(_0: `0 <= i1`)
                ...
                let (i2, result1, Post11) =
                  let (i2, result1, Post12) =
                      ...
                      | (right Test2) =>
                          let (result2, Post15) = (exist_1 [result2: unit]
                            ((i:Z)
                             (i = `i1 + 1` -> `0 <= i` /\
                              (Zwf `0` `N - i` `N - i1`))) tt
                            (p_po_3 t i0 Post1 Variant1 i1 Pre4 Pre3 Test4
                            Test2)) in
                          (exist_1 (qcomb [result3: Z]
                                    (`0 <= result3` /\ `result3 < N` ->
                                     `(access t result3) = 0`)
                    ...
                    | (Qval (exist result1 Post20)) =>
                      let (i2, result2, Post2) =
                        let (result2, Post2) = (exist_1 [result2: Z]
                          result2 = `i1 + 1` `i1 + 1`
                          (refl_equal ? `i1 + 1`)) in
                        (exist_2 [i3: Z][result3: unit]i3 = `i1 + 1` 
                        result2 tt Post2) in
                      (exist_2 [i3: Z]
                      (qcomb [result3: Z]
                       (`0 <= result3` /\ `result3 < N` ->
                       ...
                       (Zwf `0` `N - i3` `N - i1`)) i2
                      (Val Z result2)
                      (p_po_4 i0 Post1 Variant1 i1 Pre4 Pre3 Test4 Post20 i2
                      Post2))
                    | (Qexn result1 Post21) => (exist_2 [i2: Z]
                      (qcomb [result2: Z]
                       (`0 <= result2` /\ `result2 < N` ->
                        `(access t result2) = 0`)
                       [result2: unit]`0 <= i2` /\
                       (Zwf `0` `N - i2` `N - i1`)) i1 (Exn unit result1)
                      Post21)
                    end in
                  Cases (decomp1 Post12) of
                  | (Qval (exist result1 Post4)) =>
                    ((wf1 `N - i2`)
                      (p_po_5 i0 Post1 Variant1 i1 Pre4 Pre3 Test4 i2 Post4)
                      i2 (refl_equal ? `N - i2`) (proj1 ? ? Post4))
                  | (Qexn result1 Post22) => (exist_2 [i3: Z]
                    (qcomb [result2: Z]
                     (`0 <= result2` /\ `result2 < N` ->
                      `(access t result2) = 0`)
                     [result2: unit]`0 <= i3` /\ `i3 >= N`) i2
                    (Exn unit result1) Post22)
                  end in
                Cases (decomp1 Post11) of
                | (Qval (exist result1 Post3)) => (exist_2 [i3: Z]
                  (qcomb [result2: Z]
                   (`0 <= result2` /\ `result2 < N` ->
                    `(access t result2) = 0`)
                   [result2: unit]`0 <= i3` /\ `i3 >= N`) i2 (Val Z result1)
                  Post3)
                | (Qexn result1 Post23) => (exist_2 [i3: Z]
                  (qcomb [result2: Z]
                   (`0 <= result2` /\ `result2 < N` ->
                    `(access t result2) = 0`)
                   [result2: unit]`0 <= i3` /\ `i3 >= N`) i2
                  (Exn unit result1) Post23)
                end
            | (right Test1) =>
                ...
                | (Qval (exist result1 Post3)) => (exist_2 [i3: Z]
                  (qcomb [result2: Z]
                   ...
                   [result2: unit]`0 <= i3` /\ `i3 >= N`) i2 (Val Z result1)
                  Post3)
                | (Qexn result1 Post10) => (exist_2 [i3: Z]
                  (qcomb [result2: Z]
                   (`0 <= result2` /\ `result2 < N` ->
                    `(access t result2) = 0`)
                   [result2: unit]`0 <= i3` /\ `i3 >= N`) i2
      ...
      | (Qval (exist result0 Post3)) =>
        let (result1, Post25) = (exist_1 [result1: Z]
          (`0 <= result1` /\ `result1 < N` -> `(access t result1) = 0`) 
          N (p_po_7 t i0 Post1 i1 Post3)) in
        (exist_2 [i2: Z]
        (qcomb [result2: Z]
         (`0 <= result2` /\ `result2 < N` -> `(access t result2) = 0`)
         [result2: Z]
         (`0 <= result2` /\ `result2 < N` -> `(access t result2) = 0`)) 
        i1 (Val Z result1) Post25)
      | (Qexn result0 Post24) => (exist_2 [i2: Z]
        (qcomb [result1: Z]
         (`0 <= result1` /\ `result1 < N` -> `(access t result1) = 0`)
         [result1: Z]
         (`0 <= result1` /\ `result1 < N` -> `(access t result1) = 0`)) 
        i1 (Exn Z result0) Post24)
      end in
    Cases (decomp1 Post6) of
    | (Qval (exist result Post26)) => (exist_2 [i1: Z][result0: Z]
      (`0 <= result0` /\ `result0 < N` -> `(access t result0) = 0`) i0 
      result Post26)
    | (Qexn result Post27) =>
      let (result0, Post28) = (exist_1 [result0: Z]
        (`0 <= result0` /\ `result0 < N` -> `(access t result0) = 0`) 
        result Post27) in
      (exist_2 [i1: Z][result1: Z]
