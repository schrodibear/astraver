...
Require Export rev_spec_why.

(* Why obligation from file "why/rev.why", characters 165-219 *)
Lemma rev_impl_po_1 : 
  forall (p0: pointer),
  forall (alloc: alloc),
...
(* Why obligation from file "why/rev.why", characters 536-555 *)
Lemma rev_impl_po_2 : 
  forall (p0: pointer),
  forall (alloc: alloc),
  forall (tl: ((memory) pointer)),
...
(* Why obligation from file "why/rev.why", characters 249-482 *)
Lemma rev_impl_po_3 : 
  forall (p0: pointer),
  forall (tl: ((memory) pointer)),
  forall (Pre9: (is_list tl p0)),
