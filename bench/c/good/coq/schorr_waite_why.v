...
Lemma schorr_waite_impl_po_1 : 
  ...
  forall (caduceus_13: pointer),
  forall (Post2: caduceus_13 = p1),
  forall (Test5: ~(caduceus_13 = null)),
...
Lemma schorr_waite_impl_po_2 : 
  ...
  forall (caduceus_13: pointer),
  forall (Post2: caduceus_13 = p1),
  forall (Test4: caduceus_13 = null),
  forall (caduceus_12: pointer),
  forall (Post1: caduceus_12 = t1),
  forall (Test3: ~(caduceus_12 = null)),
  (valid alloc t1).
Proof.
intuition.
(* FILL PROOF HERE *)
...
Lemma schorr_waite_impl_po_3 : 
  ...
  forall (caduceus_11: Z),
  forall (Post37: caduceus_11 = (acc m0 t1)),
  forall (result2: bool),
  forall (Post39: (if result2 then caduceus_11 <> 0 else caduceus_11 = 0)),
