...
(* Why obligation from file "why/flag.why", characters 758-787 *)
Lemma flag_impl_po_1 : 
  ...
  forall (Post19: aux_1 = (shift t i1)),
  (valid alloc aux_1).
Proof.
intuition.
(* FILL PROOF HERE *)
...
Lemma flag_impl_po_2 : 
  ...
  forall (result0: Z),
  forall (Post21: result0 = (acc intP0 aux_1)),
  ((result0 = BLUE ->
    (forall (result:Z),
     (result = b1 ->
      (forall (b:Z),
...
(* Why obligation from file "why/flag.why", characters 313-706 *)
...
(* Why obligation from file "why/flag.why", characters 248-1538 *)
