...
(*i $Id: cmake.ml,v 1.47 2007-04-04 14:29:41 couchot Exp $ i*)
  ...
  print_in_file 
    (fun fmt -> 
	 ...
	 Coptions.libdir;
       ...
       fprintf fmt "\t@@echo 'why -smtlib [...] why/$*.why' && $(WHY) -smtlib --encoding mono goal   -dir smtlib $(CADULIB)/why/$(CADULIBFILE) why/%s_spec.why why/$*.why@\n@\n" f;
