...
(*i $Id: cmake.ml,v 1.40 2006-12-14 08:37:41 couchot Exp $ i*)
  ...
  print_in_file 
    (fun fmt -> 
	 ...
	 Coptions.libdir;
       ...
       fprintf fmt "\t@@echo 'why -smtlib [...] why/$*.why' && $(WHY) -smtlib --encoding mono --exp    -dir smtlib $(CADULIB)/why/$(CADULIBFILE) why/%s_spec.why why/$*.why@\n@\n" f;
