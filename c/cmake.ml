...
(*i $Id: cmake.ml,v 1.39 2006-12-13 09:28:03 couchot Exp $ i*)
  ...
  print_in_file 
    (fun fmt -> 
	 ...
	 Coptions.libdir;
       ...
       fprintf fmt "\t@@echo 'why -smtlib [...] why/$*.why' && $(WHY) -smtlib --encoding sstrat --exp --prune  -dir smtlib $(CADULIB)/why/$(CADULIBFILE) why/%s_spec.why why/$*.why@\n@\n" f;
