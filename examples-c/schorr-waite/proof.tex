...
\item[I4a] defines the backtracking stack as on
  Figure~\ref{fig:stack}. {\Huge dire que clr\_list sera defini dans le prouveur}
...
{\Huge il faut expliquer pourquoi on l'a fait et pas les autres : les
...
{\Huge discuter ces chiffres, dire que ce n'est pas si grand que ca}
