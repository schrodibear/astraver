...
\item {I4c} : the trickest annotation, means that
...
\verb|clr_list| predicate has two argument in C, but in the modeling
...
\item the number of reachable nodes which has c=0
...
reachable nodes is finite. So indeed, this an extra assumption we have
...
With, we completed all the obligations including the
...
lines, and 2411 lines of tactics were inserted manually for provng
