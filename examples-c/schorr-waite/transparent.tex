...
WF_nat, mais qui generalise a n'importe quelle relation bien fondee a
la place de < sur les nat

Cela permet de prouve la terminaison avec des mesures qui 
\begin{enumerate}
\item ne sont pas totales (cad pas defini partout)
\item a valeur dans autre chose que nat (ici nat * nat * nat)
\end{enumerate}
\end{slide}
