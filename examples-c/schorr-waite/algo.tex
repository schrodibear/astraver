...
\put(-100,120){\rnode{null2}{\makebox(0,0)[t]{\tiny NULL}}}
...
\put(80,120){\rnode{null3}{\makebox(0,0)[t]{\tiny NULL}}}
\put(100,130){\rnode{n11}}
\put(80,130){\rnode{n12}}
\ncline[linestyle=dotted]{-}{n1}{n11}
\ncline[linestyle=dotted]{-}{n1}{n12}
\ncarc[nodesepB=1mm,arcangleA=120,linewidth=1]{n0}{null}
\ncarc[arcangleA=150,linewidth=1]{n2}{n0}
\ncline{n0}{n1}
\ncline[nodesepB=1mm]{n2}{null3}
\ncline[nodesepA=1mm]{p}{n2}
\ncline[nodesep=1mm]{t}{null2}
\ncline[doubleline=true]{fig2}{fig3}\Aput{PUSH}
...
\put(-90,0){\rnode{t}{\makebox(0,0)[rt]{t}}}
\put(-110,20){\rnode{null2}{\makebox(0,0)[c]{\tiny NULL}}}
...
\ncline{n0}{n1}
\ncline[nodesepA=1mm]{p}{n2}
\ncline[nodesep=1mm]{t}{null3}
\ncline[nodesepB=1mm]{n2}{null2}
\ncline[doubleline=true]{fig3}{fig4}\Aput{SWING}
...
\ncline[nodesepA=1mm]{t}{n2}
\ncarc[nodesepB=1mm,arcangleA=120,linewidth=1]{n0}{null}
\ncline[doubleline=true]{fig4}{fig5}\Aput{POP}
...
\ncarc[nodesepB=1mm,arcangleA=-120,linewidth=1]{n0}{null}
\ncline[doubleline=true]{fig5}{fig6}\Aput{SWING}
\put(110,60){\rnode{fig6}}
\put(140,60){\rnode{fig7}}
\ncline[doubleline=true]{fig6}{fig7}\Aput{...}
...
At this point, the \caduceus{} methodology is quite different from
...
annotations. This is a good approach for runtime assertion checking,
but for formal verification this is unsuitable, because we need to reason
about reachability, not only compute it. In the \caduceus{}
methodology, such a logical notion must be 
declared, by a \verb|predicate| annotation, and supposed to be defined
or axiomatized in the back-end prover. This is very similar to a forward
...
or in the back-end prover. For the reachability
