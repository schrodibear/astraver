...
(*Why logic*) Definition lpath :
  ((memory) ((pointer) global) global) -> ((pointer) global) -> plist
  -> ((pointer) global) -> Prop.
    ...
    (forall (p1:((pointer) global)),
     (forall (l:plist),
      (forall (p2:((pointer) global)),
       ((valid alloc p1) /\ (lpath tl_global (acc tl_global p1) l p2) <->
        (lpath tl_global p1 (cons p1 l) p2))))))).
Admitted.
...
(*Why axiom*) Lemma Path_null_ax :
  (forall (tl_global:((memory) ((pointer) global) global)),
   ...
   (forall (p:((pointer) global)), (lpath tl_global p nil p))).
Admitted.
...
(*Why axiom*) Lemma Path_null_inv_ax :
  (forall (tl_global:((memory) ((pointer) global) global)),
   ...
   (forall (p:((pointer) global)),
    (forall (l:plist), ((lpath tl_global p l p) -> l = nil)))).
Admitted.
...
(*Why axiom*) Lemma llist_function_ax :
  (forall (tl_global:((memory) ((pointer) global) global)),
   ...
   (forall (l1:plist),
    (forall (l2:plist),
     (forall (p:((pointer) global)),
      ((llist tl_global p l1) -> ((llist tl_global p l2) -> l1 = l2)))))).
Admitted.
...
(*Why axiom*) Lemma llist_valid :
  (forall (tl_global:((memory) ((pointer) global) global)),
   (forall (alloc:alloc_table),
    ...
    (forall (p1:((pointer) global)),
     (forall (l:plist),
      ((llist tl_global p1 l) -> (~(p1 = null) -> (valid alloc p1))))))).
Admitted.
