...
/*@ global invariant q0 : 0 <= N < 256; */ 
/*@ global invariant q1 : 0 <= q_size <= N; */
/*@ global invariant q2 : valid_slot(q_head); */
/*@ global invariant q3 : valid_slot(q_tail); */

/*@ global invariant size_1 : (q_tail > q_head) ==> (q_size == (q_tail - q_head)); */
/*@ global invariant size_2 : (q_tail < q_head) ==> (q_size == (N + q_tail - q_head)); */
/*@ global invariant size_3 : (q_tail == q_head) <==> ((q_size == 0) || (q_size == N)); */
...
/* 
Local Variables:
compile-command: "LC_ALL=C make queue_jr"
End:
*/
