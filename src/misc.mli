...
(*i $Id: misc.mli,v 1.65 2004-02-27 08:46:19 marche Exp $ i*)
...
val pand : is_wp -> predicate -> predicate -> predicate
val pands : is_wp -> predicate list -> predicate
...
val print_in_file : int -> (Format.formatter -> unit) -> string -> unit
